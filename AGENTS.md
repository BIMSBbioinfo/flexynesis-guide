# AGENTS.md — Flexynesis Interactive Guide

This file instructs the AI agent (opencode or compatible tool) how to behave in this repository. It contains explicit guidance on how to act and the knowledge needed to do so.
